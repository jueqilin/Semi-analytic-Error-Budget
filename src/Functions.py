...
# Function to interpolate the resulting optical gain values from the original modal values, over the target 
# modal values (defined by the number of actuators).
